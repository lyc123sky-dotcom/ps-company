const values = [
  {
    ...
    accent: "hover:border-[#ff1493] hover:shadow-[0_8px_24px_rgba(255,20,147,0.08)]",
  },
  {
    icon: "🏢",
    title: "최고의 작업 환경",
    desc: "광주에 위치한 대형·소형 스튜디오와 최신 방송 장비. 콘텐츠에만 집중할 수 있는 공간을 제공합니다.",
    accent: "hover:border-[#b347ff] hover:shadow-[0_8px_24px_rgba(179,71,255,0.08)]",
  },
  {
    icon: "💎",
    title: "투명 정산 시스템",
    desc: "계약과 정산 전 과정을 투명하게. 신뢰를 기반으로 한 장기적 파트너십을 추구합니다.",
    accent: "hover:border-[#00dcff] hover:shadow-[0_8px_24px_rgba(0,220,255,0.08)]",
  },
  {
    icon: "🚀",
    title: "콘텐츠에 집중",
